      ...
      <div className="flex items-center gap-4 flex-1 justify-end transition-all duration-500">
        {isAuthenticated ? (
          <>
            ...
            {/* Profile Avatar */}
        <Link href="/profile" className="ml-2 block rounded-full hover:ring-2 hover:ring-primary/20 transition-all">
          <img 
          ...
          <div className="flex items-center gap-2">
            <Link href="/login" className="px-5 py-2.5 text-[13px] font-medium text-gray-600 hover:text-gray-900 transition-colors hidden sm:block">Đăng nhập</Link>
            <Link href="/register" className="group flex items-center gap-2 bg-primary hover:bg-primary-pressed text-white px-5 py-2.5 rounded-full font-medium text-[13px] transition-all duration-500 active:scale-[0.98] shadow-lg shadow-primary/20">
              Đăng ký miễn phí
