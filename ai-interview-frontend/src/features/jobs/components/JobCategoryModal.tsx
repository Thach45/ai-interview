            ...
            <div className="flex-1 overflow-y-auto p-2">
              {!selectedGroupId ? (
                <div className="h-full flex flex-col items-center justify-center text-text-tertiary gap-2 opacity-60">
                  ...
                  <span className="text-[12px] font-medium text-center px-4">
                    Chọn nhóm nghề để xem danh sách ngành
                  </span>
                </div>
              ) : (
                <div className="space-y-0.5">
                  ...
                  {industries.length === 0 && (
                    <p className="text-center py-10 text-[12px] text-text-tertiary italic">
