    ...
    <section id="features" className="py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-32">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-gray-900 mb-6">
          <SplitText text="Giao diện trực quan." delay={0.1} />
          <br />
          <span className="text-primary">
             <SplitText text="Trải nghiệm chân thực." delay={0.3} />
          </span>
        </h2>
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex-1 lg:pr-12">
           <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-100 text-gray-800 text-[11px] font-bold rounded-full mb-6 uppercase tracking-wider">
             <FileText size={14} /> Phân Tích ATS
           </motion.div>
           <h3 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight">
             <SplitText text="Phân Tích Độ Tương Thích CV & Mô Tả Công Việc" delay={0.1} />
           </h3>
           <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="text-gray-500 text-[16px] leading-relaxed mb-8">
           ...
           <motion.button initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }} onClick={() => setActiveVideo('Phân tích CV')} className="group flex items-center gap-2 font-bold text-gray-900 hover:text-primary transition-colors">
        ...
        {/* Real Mock UI: CV Analysis Result with TiltCard */}
        <div className="flex-1 w-full relative flex items-center justify-center" style={{ perspective: "1000px" }}>
          ...
          >
            ...
            <div>
              <p className="text-[12px] text-gray-500 font-medium">Khớp JD</p>
              <p className="text-[16px] font-bold text-gray-900">85%</p>
            </div>
          </motion.div>
      ...
      <div className="flex flex-col lg:flex-row-reverse gap-12 items-center">
        <div className="flex-1 lg:pl-12">
           ...
           <h3 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight">
             <SplitText text="Đối thoại trực tiếp với nhà tuyển dụng ảo" delay={0.1} />
           </h3>
           <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="text-gray-500 text-[16px] leading-relaxed mb-8">
           ...
           <motion.button initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }} onClick={() => setActiveVideo('Phỏng vấn giả lập')} className="group flex items-center gap-2 font-bold text-gray-900 hover:text-primary transition-colors">
             <div className="size-10 rounded-full bg-gray-100 group-hover:bg-primary/10 flex items-center justify-center transition-colors">
               <Play size={16} className="ml-1" />
             </div>
             Xem Cách Hoạt Động
        ...
        {/* Real Mock UI: Interview Room Video with TiltCard */}
        <div className="flex-1 w-full relative flex items-center justify-center" style={{ perspective: "1000px" }}>
          ...
          >
            ...
            <div>
              <p className="text-[14px] font-bold text-gray-900">Real-time Voice</p>
            </div>
          </motion.div>
