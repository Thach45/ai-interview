    ...
    <section className="bg-white border-t border-gray-100 pt-32 pb-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 1 }}>
          <Link href={isAuthenticated ? "/dashboard" : "/register"} className="inline-flex group items-center gap-3 bg-primary text-white px-10 py-5 rounded-full font-bold text-[17px] shadow-2xl hover:bg-primary-pressed transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] shadow-primary/20">
            Tạo hồ sơ đầu tiên
