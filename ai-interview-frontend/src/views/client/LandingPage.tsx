          ...
          >
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-center">
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center px-4">
                <Link href={isAuthenticated ? "/dashboard" : "/register"} className="w-full sm:w-auto group flex items-center justify-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-semibold text-[15px] shadow-[0_8px_32px_rgba(86,69,212,0.3)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98]">
                  Tối ưu CV của tôi
